...
const ClarioProcess = () => {
  return (
    <>
      <div id="use-case" className="scroll-mt-20"></div>
      <section className="mt-5 bg-gradient-to-b from-blue-50 to-blue-200 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-base sm:text-lg text-gray-700 mb-16 max-w-2xl mx-auto">
            Getting started with Clario.ai takes less than 2 minutes. No
            lawyers, no paperwork just legal clarity in your pocket.
          </p>
