    ...
    <section className="py-12 sm:py-16 bg-gradient-to-r from-blue-50 to-indigo-50 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scrollByAmount(550)}
            className="hidden sm:flex absolute -right-10 top-1/2 -translate-y-1/2 bg-white shadow-md p-2 rounded-full z-20 hover:bg-gray-100"
          >
          ...
          >
            ...
            <FeatureCard
              ...
              icon={
                <img
                  src="/images/HomePage/ai-browser-stroke-rounded 1.svg"
                  className="w-10 sm:w-12 h-10 sm:h-12"
                />
              }
            ...
            <FeatureCard
              ...
              icon={
                <img
                  src="/images/HomePage/edit-table-stroke-rounded 1.svg"
                  className="w-10 sm:w-12 h-10 sm:h-12"
                />
              }
            ...
            <FeatureCard
              ...
              icon={
                <img
                  src="/images/HomePage/smart-phone-04-stroke-rounded 1.svg"
                  className="w-10 sm:w-12 h-10 sm:h-12"
                />
              }
            ...
            <FeatureCard
              ...
              icon={
                <img
                  src="/images/HomePage/computer-phone-sync-stroke-rounded 1.svg"
                  className="w-10 sm:w-12 h-10 sm:h-12"
                />
              }
