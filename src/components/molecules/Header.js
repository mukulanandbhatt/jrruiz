  ...
  return (
    ...
    <header className="fixed top-5 left-1/2 -translate-x-1/2 z-50 w-[1296px]">
      ...
      className={`inline-block w-2 h-2 border-r-2 border-b-2 ${
        activeNav === "/product" ? "border-blue-500" : "border-gray-700 dark:border-gray-200"
    ...
    />
          ...
          >
            ...
            <span
      className={`inline-block w-2 h-2 border-r-2 border-b-2 ${
        activeNav === "/use-cases" ? "border-blue-500" : "border-gray-700 dark:border-gray-200"
      } rotate-45 transition-transform duration-300`}
    />
          </Link>
          <Link
          ...
          >
            ...
            <span
      className={`inline-block w-2 h-2 border-r-2 border-b-2 ${
        activeNav === "/pricing" ? "border-blue-500" : "border-gray-700 dark:border-gray-200"
      } rotate-45 transition-transform duration-300`}
    />
          </Link>
          <Link
          ...
          >
            ...
            <span
              className={`inline-block w-2 h-2 border-r-2 border-b-2 ${
                activeNav === "/resources" ? "border-blue-500" : "border-gray-700 dark:border-gray-200"
              } rotate-45 transition-transform duration-300`}
            />
          </Link>
          <Link
          ...
          >
            ...
            <span
              className={`inline-block w-2 h-2 border-r-2 border-b-2 ${
                activeNav === "/enterprise" ? "border-blue-500" : "border-gray-700 dark:border-gray-200"
              } rotate-45 transition-transform duration-300`}
            />
          </Link>
