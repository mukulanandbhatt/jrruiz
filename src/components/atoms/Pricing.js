      ...
      <div className="py-16 bg-white px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto relative z-10">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <button className="mt-6 w-full h-12 text-black py-2 rounded-full hover:bg-blue-700 hover:text-white transition border-2 border-blue-600 cursor-pointer">
                {plan.button}
              </button>
            </div>
          ))}
        ...
        <div className="mt-16 text-center relative z-10">
          ...
          <p className="text-gray-800 mt-2 max-w-2xl mx-auto">
            ...
            editor. Want a tailored demo or downloadable comparison chart? Let
            us know!
          </p>
        </div>
      </div>
